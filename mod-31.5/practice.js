...
const person = 'saiful'
let age = 25;
const templateString = `Hey ${person}, your age is ${age}`;
...
const numArray = [123, 32, 23, 534, 656, 77, 12];
const numArrayMap = numArray.map(num => num * 5);
console.log(numArrayMap);

// ৬. [ চ্যালেঞ্জিং। গুগলে সার্চ দিয়ে বের করো ] অনেকগুলা সংখ্যার একটা array থেকে শুধু বিজোড় সংখ্যা বের করে নিয়ে আসার জন্য filter ইউজ করো 

const numArray2 = [123, 32, 23, 534, 656, 77, 12];
const numArrayFilter = numArray2.filter(num => {
    if (num % 2 == 0) {
        return num;
    }
});
...
const mobilePrice = mobile.find(num => {
    if (num.price === 5000) {
        return num;
    }
});
